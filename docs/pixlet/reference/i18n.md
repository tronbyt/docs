...
2. Add one JSON file per locale using a [BCP 47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt)
...
!!! tip "Example"
    ...
    [`examples/i18n/main.star`](https://github.com/tronbyt/pixlet/tree/main/examples/i18n/main.star) contains a minimal end-to-end example that loads
    `i18n.star`, defines translations in [`locales/es.json`](https://github.com/tronbyt/pixlet/tree/main/examples/i18n/locales/es.json), and renders localized
