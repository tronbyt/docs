...
## Quick Start
Fork and clone the [Tronbyt apps repo](https://github.com/tronbyt/apps) to your local machine, and then run the following from the local folder to generate everything you need!
```
pixlet create
```
